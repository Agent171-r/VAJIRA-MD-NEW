...
global.owner = process.env.OWNER_NUMBER  || '2349018045823' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=zZVgkATb#_iUa82exeOE-kQKcwMQEMIUr-zGYr_TE1N9uQFyxYvY ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "2349018045823" : process.env.MODERATORS ,    
